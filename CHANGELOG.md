...
### Changed
- Updated to .NET 8
- Replaced ImageSharp image generation with SkiaSharp rendering
- Removed SixLabors image rendering dependencies
...
- Made SkiaSharp package dependencies open-ended to allow future updates
